...
<body>
   <form action="ManagerServlet_sadmin" method="get">
	   <input type="hidden" name="method" value="findUseListSa">
	  <div class="box">
		 <div class="menu">
			 <div class="b">
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 ...
			 <div class="c1">
				 ...
				 <div class="e">
					<a href="ManagerServlet_sadmin?method=find_select"><img src="./imgs/zuojiantoub.png" width=40px height=40px></a>
			    </div>		 
		<center>
	    <div class="d">
		<center>
		<table>
			<tr>
				<td colspan="2" style="color: black">
					<center><input type="radio" name="queryType" value="1" checked="checked" onclick="document.getElementById('patent1').style.visibility='hidden';document.getElementById('patent2').style.visibility='hidden';document.getElementById('patent3').style.visibility='hidden';document.getElementById('patent4').style.visibility='hidden';"><span>查询所有使用记录</span></center><br>
					<center><input type="radio" name="queryType" value="2" onclick="document.getElementById('patent1').style.visibility='visible';document.getElementById('patent2').style.visibility='hidden';document.getElementById('patent3').style.visibility='hidden';document.getElementById('patent4').style.visibility='hidden';"><span>查询机房使用记录</span></center>
					...
					<center><input type="radio" name="queryType" value="3" onclick="document.getElementById('patent1').style.visibility='hidden';document.getElementById('patent2').style.visibility='visible';document.getElementById('patent3').style.visibility='hidden';document.getElementById('patent4').style.visibility='hidden';"><span>查询学生使用记录</span></center>
					<center><input id="patent2" value="输入学号" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="visibility:hidden; color:#999999" type="text" name="queryString3"/></center>
					<center><input type="radio" name="queryType" value="4" onclick="document.getElementById('patent1').style.visibility='hidden';document.getElementById('patent2').style.visibility='hidden';document.getElementById('patent3').style.visibility='visible';document.getElementById('patent4').style.visibility='visible';"><span>查询电脑使用记录</span></center>
