...
<body>
   <form action="ManagerServlet_jadmin" method="get">
	  ...
	  <div class="box">
		...
		<center>
<%
      List<User> recordList=(List<User>) request.getAttribute("recordList");
      String classn=(String) request.getAttribute("classn");
      DefaultCategoryDataset dataset = new DefaultCategoryDataset();
      for(int i = 0 ; i < recordList.size() ; i++) {
    	     dataset.addValue(recordList.get(i).getUset(), classn,recordList.get(i).getNo());
    	}
     ...
     JFreeChart chart1 = ChartFactory.createBarChart3D(classn+"班班级上机统计", 
                       "学号(162042+)",
                       "上机学时(小时)",
                       dataset,
