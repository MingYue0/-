		...
		<table>
			<tr>
				<td colspan="2" style="color: black">
					<center><input type="radio" name="queryType" value="1" checked="checked" onclick="document.getElementById('patent1').style.visibility='visible';document.getElementById('patent3').style.visibility='hidden';document.getElementById('patent4').style.visibility='hidden';"><span>通过班级查询用户</span></center><br>
					<center><input type="text" name="queryString1" id="patent1" value="输入班级" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="visibility:visible; color:#999999"/>	</center>
					<center><input type="radio" name="queryType" value="2" onclick="document.getElementById('patent1').style.visibility='hidden';document.getElementById('patent3').style.visibility='visible';document.getElementById('patent4').style.visibility='hidden';"><span>通过学院查询用户</span></center><br>
					...
					<center><input type="radio" name="queryType" value="0" onclick="document.getElementById('patent1').style.visibility='hidden';document.getElementById('patent3').style.visibility='hidden';document.getElementById('patent4').style.visibility='visible';"><span>通过学号查询用户</span></center><br>
