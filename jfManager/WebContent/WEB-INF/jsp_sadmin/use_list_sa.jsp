...
<form action="ManagerServlet_sadmin" method="get" id="queryForm">
	  ...
	  <div class="box">
		 <div class="menu">
			 ...
			 <div class="e">
			     <a href="ManagerServlet_sadmin?method=findUseSa"><img src="./imgs/zuojiantoub.png" width=40px;height=40px></a>
			 </div> 
		 <div class="d">
			  <center>
			      <c:forEach items= "${requestScope.page.recordList }" var="use" varStatus="status">
					   <div style="color: #242262;width: 250px;height: 280px;border-radius: 10px;background: #FFFFFF;float: left;margin-left:30px ;margin-top: 50px">
                       <br>
                       <center>
                          <table>
                            <tr><td>序号:</td><td>${status.count }</td></tr>
                            <tr><td>使用者学号:</td><td>${use.no }</td></tr>
                            <tr><td>使用者姓名:</td><td>${use.username }</td></tr>
                            <tr><td>机房号:</td><td>${use.classno }</td></tr>
                            <tr><td>电脑编号:</td><td>${use.comno }</td></tr>
                            <tr><td>上机时间:</td><td>${use.stime }</td></tr>
                            <tr><td>下机时间:</td><td>${use.etime }</td></tr>
                          </table>
                        </center>  
                        </div>
                   </c:forEach>
