...
<body>
   <form action="ManagerServlet_sadmin" method="get">
	   <input type="hidden" name="method" value="analyse_class_chart">
	  <div class="box">
		 <div class="menu">
			 <div class="b">
			    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table>
			<tr>
				<td colspan="2" style="color: black">
					<center><input value="输入班级号" onFocus="if(value==defaultValue){value='';this.style.color='#000'}" onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999999" type="text" name="queryString"/></center>
					<center><button type="submit" >查看</button></center>
				</td>
