	   ...
	   <div class="box">
		 <div class="menu">
			 ...
			 <div class="c1">
				 ...
				 <div class="e">
					<a href="ManagerServlet_jadmin?method=comManagePlan"><img src="./imgs/zuojiantou.png" width=40px height=40px></a>
			    </div>		   
		   <center>
		   <div class="d">
		      <a href="ManagerServlet_jadmin?method=comList&classno=301" ><img src="./imgs/301.jpg" width="350px" height="250px"></a>
		      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		      <a href="ManagerServlet_jadmin?method=comList&classno=302" ><img src="./imgs/302.jpg" width="350px" height="250px" ></a>
		   </div>
		   <div class="d">
		      <a href="ManagerServlet_jadmin?method=comList&classno=303" ><img src="./imgs/303.jpg" width="350px" height="250px" ></a>
		      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		      <a href="ManagerServlet_jadmin?method=comList&classno=304" ><img src="./imgs/304.jpg" width="350px" height="250px" ></a>
		   </div>
		   <!--<div class="d">
		      <a href="ManagerServlet_jadmin?method=comList&classno=305" ><img src="./imgs/303.jpg" width="350px" height="250px" ></a>
		      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		      <a href="ManagerServlet_jadmin?method=comList&classno=306" ><img src="./imgs/304.jpg" width="350px" height="250px" ></a>
		   </div>
		   <div class="d">
		      <a href="ManagerServlet_jadmin?method=comList&classno=307" ><img src="./imgs/303.jpg" width="350px" height="250px" ></a>
		      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		      <a href="ManagerServlet_jadmin?method=comList&classno=308" ><img src="./imgs/304.jpg" width="350px" height="250px" ></a>
		   </div>-->
		   </center>
        </div>
     </form>
