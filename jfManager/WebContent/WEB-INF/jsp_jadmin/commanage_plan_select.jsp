...
<body>
     <div class="box">
		 ...
		 <div class="d">
			  <center>
			      <a href="ManagerServlet?method=list2"><img src="./imgs/7.png" width="250" height="250px"></a>
			      <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
			      <a href="ManagerServlet_jadmin?method=classList"><img style="border-radius: 10px" src="./imgs/co.png" width="300" height="300px"></a>
			  </center>
	     </div><br>
	     <div>
			 <center>
